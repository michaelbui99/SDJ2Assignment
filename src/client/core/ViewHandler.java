...
import client.view.controlView.ControlViewController;
...
public class ViewHandler extends javafx.application.Application
{
  ...
  public void openView(String id) throws IOException
  {
    ...
    if (id.equals("Main"))
    {
    loader.setLocation(getClass().getResource("../client.view/mainView/" + id +"View.fxml"));
    root = loader.load();
    ...
    {
      loader.setLocation(getClass().getResource("../client.view/controlView/" + id +"View.fxml"));
      root = loader.load();
